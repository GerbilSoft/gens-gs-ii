...
SET(GENS_CXX_FLAGS_COMMON "${GENS_CXX11_CXXFLAG} ${GENS_CXX_NO_RTTI_CFLAG} ${GENS_CXX_NO_EXCEPTIONS_CFLAG}")
SET(GENS_EXE_LINKER_FLAGS_COMMON "")
UNSET(GENS_C99_CFLAG)
UNSET(GENS_CXX11_CXXFLAG)
UNSET(GENS_CXX_NO_RTTI_CFLAG)
UNSET(GENS_CXX_NO_EXCEPTIONS_CFLAG)
...
# Debug/release flags.
SET(GENS_C_FLAGS_DEBUG "-O0 -ggdb -DDEBUG -D_DEBUG")
SET(GENS_CXX_FLAGS_DEBUG "-O0 -ggdb -DDEBUG -D_DEBUG")
