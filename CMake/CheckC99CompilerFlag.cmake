...
MACRO(CHECK_C99_COMPILER_FLAG _RESULT)
	...
	FOREACH(CHECK_C99_CFLAG "-std=gnu99" "-std=c99" "-c99" "-AC99" "-xc99=all" "-qlanglvl=extc99")
		...
		CHECK_C_SOURCE_COMPILES("int main() { return 0;}" CFLAG_${CHECK_C99_CFLAG}_TEST)
		SET(CMAKE_REQUIRED_DEFINITIONS "${SAFE_CMAKE_REQUIRED_DEFINITIONS}")
		IF(CFLAG_${CHECK_C99_CFLAG}_TEST)
			SET(${_RESULT} ${CHECK_C99_CFLAG})
			BREAK()
		ENDIF(CFLAG_${CHECK_C99_CFLAG}_TEST)
		UNSET(CFLAG_${CHECK_C99_CFLAG}_TEST)
	ENDFOREACH()
