...
MACRO(CHECK_CXX11_COMPILER_FLAG _RESULT)
	...
	FOREACH(CHECK_CXX11_CXXFLAG "-std=gnu++0x" "-std=c++0x")
		...
		CHECK_CXX_SOURCE_COMPILES("int main() { void *ptr = nullptr; return 0; }" CXXFLAG_${CHECK_CXX11_CXXFLAG})
		SET(CMAKE_REQUIRED_DEFINITIONS "${SAFE_CMAKE_REQUIRED_DEFINITIONS}")
		IF(CXXFLAG_${CHECK_CXX11_CXXFLAG})
			SET(${_RESULT} ${CHECK_CXX11_CXXFLAG})
			BREAK()
		ENDIF(CXXFLAG_${CHECK_CXX11_CXXFLAG})
		UNSET(CXXFLAG_${CHECK_CXX11_CXXFLAG})
	ENDFOREACH()
