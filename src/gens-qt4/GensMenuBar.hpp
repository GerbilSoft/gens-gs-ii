...
#define IDM_BPPTEST_MENU	65
#define IDM_BPPTEST_15		MNUID(IDM_BPPTEST_MENU, 1)
#define IDM_BPPTEST_16		MNUID(IDM_BPPTEST_MENU, 2)
#define IDM_BPPTEST_32		MNUID(IDM_BPPTEST_MENU, 3)
