...
class PathConfigPrivate
{
	...
	private:
		PathConfig *const q_ptr;
		Q_DECLARE_PUBLIC(PathConfig)
	private:
 ...
 */
QString PathConfig::configPath(void) const
{
	Q_D(const PathConfig);
 ...
 */
QString PathConfig::configPath(ConfigPath path) const
{
