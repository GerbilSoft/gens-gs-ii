...
#define IDM_FILE_RECENT_MENU	2
#define IDM_FILE_RECENT_1	MNUID(IDM_FILE_RECENT, 1)
#define IDM_FILE_RECENT_2	MNUID(IDM_FILE_RECENT, 2)
#define IDM_FILE_RECENT_3	MNUID(IDM_FILE_RECENT, 3)
#define IDM_FILE_RECENT_4	MNUID(IDM_FILE_RECENT, 4)
#define IDM_FILE_RECENT_5	MNUID(IDM_FILE_RECENT, 5)
#define IDM_FILE_RECENT_6	MNUID(IDM_FILE_RECENT, 6)
#define IDM_FILE_RECENT_7	MNUID(IDM_FILE_RECENT, 7)
#define IDM_FILE_RECENT_8	MNUID(IDM_FILE_RECENT, 8)
#define IDM_FILE_RECENT_9	MNUID(IDM_FILE_RECENT, 9)

#define IDM_GRAPHICS_MENU	3
#ifndef Q_WS_MAC
...
#define IDM_GRAPHICS_RES_MENU	4
...
#define IDM_GRAPHICS_BPP_MENU	5
...
#define IDM_GRAPHICS_STRETCH_MENU	6
...
#define IDM_SYSTEM_CPURESET_S68K	MNUID(IDM_SYSTEM_MENU, 22)
#define IDM_SYSTEM_CPURESET_MSH2	MNUID(IDM_SYSTEM_MENU, 23)
#define IDM_SYSTEM_CPURESET_SSH2	MNUID(IDM_SYSTEM_MENU, 24)
#define IDM_SYSTEM_CPURESET_Z80		MNUID(IDM_SYSTEM_MENU, 25)

#define IDM_SYSTEM_REGION_MENU		8
...
#define IDM_OPTIONS_MENU	9
#define IDM_OPTIONS_ENABLESRAM	MNUID(IDM_OPTIONS_MENU, 1)
#define IDM_OPTIONS_CONTROLLERS	MNUID(IDM_OPTIONS_MENU, 2)
