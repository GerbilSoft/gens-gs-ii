...
#define IDM_GRAPHICS_RES	MNUID(IDM_GRAPHICS_MENU, 1)
#define IDM_GRAPHICS_BPP	MNUID(IDM_GRAPHICS_MENU, 2)
#define IDM_GRAPHICS_STRETCH	MNUID(IDM_GRAPHICS_MENU, 3)
#define IDM_GRAPHICS_SCRSHOT	MNUID(IDM_GRAPHICS_MENU, 4)
...
// General actions.
#define IDM_NOMENU_HARDRESET	MNUID(IDM_NOMENU, 1)
#define IDM_NOMENU_SOFTRESET	MNUID(IDM_NOMENU, 2)
#define IDM_NOMENU_PAUSE	MNUID(IDM_NOMENU, 3)
