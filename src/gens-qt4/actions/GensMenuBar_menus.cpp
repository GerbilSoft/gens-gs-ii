...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiFile[] =
{
	...
	{IDM_FILE_LOADSTATE, GMI_NORMAL, QT_TR_NOOP("&Load State"), QAction::NoRole, 0, NULL, NULL},
	{IDM_SEPARATOR, GMI_SEPARATOR, NULL, QAction::NoRole, 0, NULL, NULL},
#ifdef Q_WS_MAC
	// Qt/Mac moves the "Preferences" item to the Application menu.
	{IDM_FILE_GENCONFIG, GMI_NORMAL, QT_TR_NOOP("&Preferences..."), QAction::PreferencesRole, 0, NULL, "configure"},
#else
	{IDM_FILE_GENCONFIG, GMI_NORMAL, QT_TR_NOOP("&General Configuration"), QAction::PreferencesRole, 0, NULL, "configure"},
#endif
	{IDM_FILE_MCDCONTROL, GMI_NORMAL, QT_TR_NOOP("Sega C&D Control Panel"), QAction::NoRole, 0, NULL, "media-optical"},
	
	// Qt/Mac moves the "Quit" item to the Application menu.
#ifndef Q_WS_MAC
	{IDM_SEPARATOR, GMI_SEPARATOR, NULL, QAction::NoRole, 0, NULL, NULL},
#endif
	{IDM_FILE_QUIT, GMI_NORMAL, QT_TR_NOOP("&Quit"), QAction::QuitRole, 0, NULL, "application-exit"},
...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiGraphicsRes[] =
{
	...
	{IDM_GRAPHICS_RES_3X, GMI_RADIO, QT_TR_NOOP("960x720 (&3x)"), QAction::NoRole, 0, NULL, NULL},
	{IDM_GRAPHICS_RES_4X, GMI_RADIO, QT_TR_NOOP("1280x960 (&4x)"), QAction::NoRole, 0, NULL, NULL},
...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiGraphicsBpp[] =
{
	...
	{IDM_GRAPHICS_BPP_32, GMI_RADIO, QT_TR_NOOP("32-bit (888)"), QAction::NoRole, 0, NULL, NULL},
...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiGraphicsStretch[] =
{
	...
	{IDM_GRAPHICS_STRETCH_V, GMI_RADIO, QT_TR_NOOP("Vertical Only"), QAction::NoRole, 0, NULL, NULL},
	{IDM_GRAPHICS_STRETCH_FULL, GMI_RADIO, QT_TR_NOOP("Full Stretch"), QAction::NoRole, 0, NULL, NULL},
...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiSystemRegion[] =
{
	...
	{IDM_SYSTEM_REGION_ASIA, GMI_RADIO, QT_TR_NOOP("A&sia (PAL)"), QAction::NoRole, 0, NULL, NULL},
	{IDM_SYSTEM_REGION_USA, GMI_RADIO, QT_TR_NOOP("&USA (NTSC)"), QAction::NoRole, 0, NULL, NULL},
	{IDM_SYSTEM_REGION_EUROPE, GMI_RADIO, QT_TR_NOOP("&Europe (PAL)"), QAction::NoRole, 0, NULL, NULL},
...
const GensMenuBar::MenuItem GensMenuBar::ms_gmiSoundTest[] =
{
	...
	{IDM_SOUNDTEST_22050, GMI_NORMAL, "&22,050 Hz", QAction::NoRole, 0, NULL, NULL},
	{IDM_SOUNDTEST_32000, GMI_NORMAL, "&32,000 Hz", QAction::NoRole, 0, NULL, NULL},
	{IDM_SOUNDTEST_44100, GMI_NORMAL, "&44,100 Hz", QAction::NoRole, 0, NULL, NULL},
	{IDM_SOUNDTEST_48000, GMI_NORMAL, "4&8,000 Hz", QAction::NoRole, 0, NULL, NULL},
	{IDM_SEPARATOR, GMI_SEPARATOR, NULL, QAction::NoRole, 0, NULL, NULL},
	{IDM_SOUNDTEST_MONO, GMI_NORMAL, QT_TR_NOOP("Mono"), QAction::NoRole, 0, NULL, NULL},
	{IDM_SOUNDTEST_STEREO, GMI_NORMAL, QT_TR_NOOP("Stereo"), QAction::NoRole, 0, NULL, NULL},
