...
class GensKeySequenceWidgetPrivate
{
	...
	private:
		GensKeySequenceWidget *const q_ptr;
		Q_DECLARE_PUBLIC(GensKeySequenceWidget)
	private:
 ...
 */
void GensKeySequenceWidgetPrivate::startRecording(void)
{
	nKey = 0;
	modifierKeys = 0;
...
{
	Q_D(const GensKeySequenceWidget);
