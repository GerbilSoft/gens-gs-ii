...
class PngWriterPrivate
{
	...
	public:
		...
		/**
		 * PNG write transform: Convert 16-bit (565) color to 24-bit color.
		 * @param png_ptr PNG pointer.
		 * @param row_info_ptr Row information pointer.
		 * @param data Data.
		 */
		static void png_write_transform_fn_16to24(png_structp png_ptr, png_row_infop row_info_ptr, png_bytep data);
};
