...
typedef enum
{
	...
	DISC_TYPE_DVD_PLUS_R_DL		= (1 << 13),
	DISC_TYPE_BDROM			= (1 << 14),
	DISC_TYPE_BD_R			= (1 << 15),
	DISC_TYPE_BD_RE			= (1 << 16),
	DISC_TYPE_HDDVD			= (1 << 17),
	DISC_TYPE_HDDVD_R		= (1 << 18),
	DISC_TYPE_HDDVD_RAM		= (1 << 19),
	DISC_TYPE_HDDVD_RW		= (1 << 20),
	DISC_TYPE_HDDVD_R_DL		= (1 << 21),
	DISC_TYPE_HDDVD_RW_DL		= (1 << 22),
} CD_DiscType_t;
