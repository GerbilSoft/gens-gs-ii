...
mdZ80_context *mdZ80_new(void)
{
	...
	// 0x76 == HALT
	memset(mdZ80_insn_fetch, 0x76, sizeof(mdZ80_insn_fetch));
...
void mdZ80_soft_reset(mdZ80_context *z80)
{
	...
	z80->IX = 0xFFFF;	// old Gens; also genplus-gx
	z80->IY = 0xFFFF;	// old Gens; also genplus-gx
	
	// TODO: Initialize AF2 to 0xFFFF?
	z80->AF = 0xFFFF;		// [1]; Gens originally used 0x4000 (ZF only).
	z80->SP = 0xFFFF;		// [1]
	z80->IFF = 0;			// [1]
	z80->R = 0;			// [2]
	z80->I = 0;			// [2]
...
/**
 * Add cycles to the Z80 odometer.
 * @param z80 Pointer to Z80 context.
...
/**
 * Add an instruction fetch handler.
