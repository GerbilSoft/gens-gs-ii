...
// NOTE: src/libgens/Util/ directory must be specified.
// This file is generated by CMake and placed in the build/ directory.
// TODO: Figure out some way to trim this.
#include "src/libgens/Util/byteorder.h"
