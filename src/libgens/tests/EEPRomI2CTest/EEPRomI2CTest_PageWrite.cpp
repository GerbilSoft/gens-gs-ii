...
class EEPRomI2CTest_PageWrite : public EEPRomI2CTest
{
	protected:
		...
		/**
		 * Mode 3 EEPROM: Test full pages writes in an EEPROM.
		 * Starts at the specified address.
		 * NOTE: Each byte is written exactly once.
		 * Wraparound can be tested by starting at an address
		 * within the page instead of at the start of the page.
		 ...
		 * @param pgSize Page size.
		 */
		void eprMode3_pageWrite(unsigned int addr_start, unsigned int eepromSize, unsigned int pgSize);
};
 ...
 * @param pgSize Page size.
 */
void EEPRomI2CTest_PageWrite::eprMode3_pageWrite(unsigned int addr_start, unsigned int eepromSize, unsigned int pgSize)
{
	const unsigned int eepromMask = eepromSize - 1;
	const unsigned int pgMask = pgSize - 1;
...
/**
 * 24C32: Test sequential writing of full pages.
 * Starts at the specified address.
 * NOTE: Each byte is written exactly once.
 * Wraparound can be tested by starting at an address
 * within the page instead of at the start of the page.
 * @param addr_start Starting address.
 */
TEST_P(EEPRomI2CTest_PageWrite, epr24C32_pageWrite)
{
	unsigned int addr_start = GetParam();
	...
	// Run the Mode 3 test.
	eprMode3_pageWrite(addr_start, eepromSize, pgSize);
}

/**
 * 24C64: Test sequential writing of full pages.
 * Starts at the specified address.
 * NOTE: Each byte is written exactly once.
 * Wraparound can be tested by starting at an address
 * within the page instead of at the start of the page.
 * @param addr_start Starting address.
 */
TEST_P(EEPRomI2CTest_PageWrite, epr24C64_pageWrite)
{
	unsigned int addr_start = GetParam();
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x1000_0x13FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C64, part 1
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x1400_0x17FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C64, part 2
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x1800_0x1BFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C64, part 3
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x1C00_0x1FFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C64, part 4
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x2000_0x23FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 1
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x2400_0x27FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 2
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x2800_0x2BFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 3
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x2C00_0x2FFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 4
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x3000_0x33FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 5
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x3400_0x37FF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 6
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x3800_0x3BFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 7
...
INSTANTIATE_TEST_CASE_P(PageWrite_0x3C00_0x3FFF, EEPRomI2CTest_PageWrite,
	::testing::Values(
		// 24C128, part 8
