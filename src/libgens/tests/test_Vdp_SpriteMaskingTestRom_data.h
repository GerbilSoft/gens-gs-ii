...
#ifndef __LIBGENS_TEST_VDP_SPRITEMASKINGTESTROM_DATA_H__
#define __LIBGENS_TEST_VDP_SPRITEMASKINGTESTROM_DATA_H__
...
#endif /* __LIBGENS_TEST_VDP_SPRITEMASKINGTESTROM_DATA_H__ */
