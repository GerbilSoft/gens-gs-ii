 ...
 * EffectTest.hpp: Effect test base class.                                 *
 *                                                                         *
...
#ifndef __LIBGENS_TESTS_EFFECTS_EFFECTTEST_HPP
#define __LIBGENS_TESTS_EFFECTS_EFFECTTEST_HPP
...
struct EffectTest_flags {
	uint32_t cpuFlags;
	uint32_t cpuFlags_slow;

	EffectTest_flags(uint32_t cpuFlags, uint32_t cpuFlags_slow)
	{
...
class EffectTest : public ::testing::TestWithParam<EffectTest_flags>
{
	protected:
		EffectTest()
			: ::testing::TestWithParam<EffectTest_flags>()
			, fb_normal(nullptr)
			, fb_paused(nullptr)
			, fb_test1(nullptr)
			, fb_test2(nullptr) { }
...
#endif /* __LIBGENS_TESTS_EFFECTS_EFFECTTEST_HPP */
